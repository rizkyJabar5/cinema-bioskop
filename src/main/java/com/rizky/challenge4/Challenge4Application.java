...
import static com.rizky.challenge4.backend.model.SeatsRowEnum.B;
...
public class Challenge4Application {
    ...
    @Bean
    CommandLineRunner createData(UserService userService, FilmService service, SeatService seatService) {
        return args -> {
